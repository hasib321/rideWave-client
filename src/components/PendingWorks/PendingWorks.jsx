...
const PendingWorks = ({ pendingBooking, refetch }) => {
  const {
    _id,
    serviceName,
  ...
  const [pendingValue, setPendingValue] = useState(serviceStatus);
  ...
  const handlePendingWork = (e) => {
    ...
    fetch(`http://localhost:5000/booking/${_id}`, {
      ...
      body: JSON.stringify({ ...pendingUpdate, serviceStatus: val }),
    })
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
      ...
      <div className="bg-[#e2f4ea] p-5">
        ...
        <div className="">
          ...
          <div>
            ...
            <p className="my-1">
              service status: <span className="text-xl">{pendingValue}</span>
            </p>
          </div>
