...
const ServiceDetails = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-8">
        ...
        <div className="col-span-9">
          <div>
            <div className="bg-[#e2f4ea]  rounded p-5 ">
              <div>
                <img className="w-full h-96 rounded" src={image} alt="" />
              </div>
              <div className="py-7 ">
                ...
                <button
                  className="btn w-32 bg-[#0b996f] border-none text-white hover:bg-[#0b996f] mt-4"
                  onClick={() =>
                ...
                <dialog id="my_modal_1" className="modal">
                  <div className="modal-box">
                    <ModaLInput services={services}></ModaLInput>
                    <div className="modal-action">
                      <form method="dialog">
                        {/* if there is a button in form, it will close the modal */}
                        <button className="btn w-32 bg-red-600 border-none text-white hover:bg-red-600 mt-4">
                          Close
                        </button>
                      </form>
                    </div>
      ...
      <div>
        <h1 className="text-[#0b996f] text-5xl font-semibold text-center my-20">
          Our Other Services
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {showCard.map((otherCard) => (
            <OtherServices otherCard={otherCard} key={_id}></OtherServices>
          ))}
        </div>
      </div>
    </div>
